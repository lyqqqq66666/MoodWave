...
export function LoginCardTest() {
  ...
  return (
    <div className="relative w-full max-w-md px-4">
      ...
      {/* 带有毛玻璃效果和彩色发光阴影的卡片 */}
      <div
        className="relative z-20 overflow-hidden rounded-full border border-white/40 px-10 py-12 md:px-16 md:py-20"
        style={{
          background: "rgba(245,230,255,0.6)",
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/90 bg-white/90 py-3 pl-10 pr-4 text-sm text-foreground placeholder:text-muted-foreground/40 focus:border-lilac/30 focus:outline-none focus:ring-2 focus:ring-lilac/20 transition-all"
                  style={{
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="round border border-white/50"
              />
              <label
                htmlFor="remember"
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, hsl(120, 60%, 60%) 0%, hsl(199, 80%, 68%) 50%, hsl(15, 70%, 75%) 100%)",
                boxShadow:
